(function ($) {
  ...
  $(function () {
    if ($("#googlemap").length) {
      ...
      const markers = [
        {
          position: { lat: 57.70808152515298, lng: 11.997316854448032 },
          title: "Södra Gubberogatan 32, 416 63 Göteborg",
          content: "<p style='margin-top: 0; font-size: 12px; line-height: 1.3;'>Södra Gubberogatan 8<br/>416 63 Göteborg</p>",
        },
        {
          position: { lat: 57.724817416601226, lng: 12.034993540957029 },
          title: "Torpavallsgatan 11, 416 73 Göteborg",
          content: "<p style='margin-top: 0; font-size: 12px; line-height: 1.3;'>Torpavallsgatan 11<br/>416 73 Göteborg</p>",
        },
        {
          position: { lat: 55.673036335409556, lng: 12.55979431766156 },
          title: "Vesterbrogade 19, 1620 København Vesterbro, Denmark",
          content: "<p style='margin-top: 0; font-size: 12px; line-height: 1.3;'>Vesterbrogade 19<br/>1620 København Vesterbro<br/>Denmark</p>",
        },
        {
          position: { lat: 47.56608762613551, lng: 14.242873786453107 },
          title: "Gewerbepark 11, 4844 Regau, Austria",
          content: "<p style='margin-top: 0; font-size: 12px; line-height: 1.3;'>Gewerbepark 11<br/>4844 Regau<br/>Austria</p>",
        },
      ];
      ...
      async function initMap() {
        ...
        // const marker = new AdvancedMarkerElement({
        //   position: { lat: 57.71139217122669, lng: 11.99901179003013 },
        //   title: "Norra Gubberogatan 32, 416 63 Göteborg",
        //   //@ts-ignore
        //   anchorTop: "-50%",
        //   gmpClickable: true,
        // });
