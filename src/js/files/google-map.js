(function ($) {
  ...
  $(function () {
    if ($("#googlemap").length) {
      ...
      function showMapUI() {        
        document.getElementById('map-consent-notice').style.display = 'none';
      ...
      function hideMapUI() {        
        document.getElementById('map-consent-notice').style.display = 'flex';
      ...
      setInterval(function() {
        if (window.CookieConsent && window.CookieConsent.consent) {
          if (window.CookieConsent.consent.marketing && !mapInitialized) {
            showMapUI();
          } else if (!window.CookieConsent.consent.marketing && mapInitialized) {
            hideMapUI();
          }
        }
      }, 1000);
